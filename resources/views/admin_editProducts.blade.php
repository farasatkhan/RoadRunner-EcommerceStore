            ...
            <div class="row">
                ...
                <div class="col-lg-9 col-md-9 col-12 dashboard-content">
                    <div class="row main-dashboard-content">
                        ...
                        <!-- <div class="col-3 offset-1 mt-5 shoes-cards">
                            <div class="shoe-image">
                                <img class="shoe-image-item" src="images/productImages/Buoyant_Blue_Blizzard.png" alt="">
                            </div>
                            <div class="shoe-title">
                                <p class="shoe-title-label">Men's Shoes</p>
                                <button class="shoe-edit-button">EDIT</button>
                            </div>
                        </div> -->
                        ...
                        <?php
                            for($i = 0; $i < count($shoesDataArray); $i++){
                                ...
                                print '<div class="col-3 offset-1 mt-5 shoes-cards">';
                                    print '<div class="shoe-image">';
                                        print '<img class="shoe-image-item" src="'.asset('/uploads/'.$imageSrc[0]).'" alt="" >';
                                    print '</div>';
                                    print '<div class="shoe-title">';
                                        print '<p class="shoe-title-label">'.$shoesDataArray[$i][1].'</p>';
                                        print '<a href="/admin_updateProducts?id='.$shoesDataArray[$i][0].'"><button class="shoe-edit-button">EDIT</button> </a>';
                                    print '</div>';
                                print '</div>';  
                            }
                        ?>
