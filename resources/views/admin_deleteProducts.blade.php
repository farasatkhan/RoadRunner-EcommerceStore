...
<nav class="navbar navbar-light navbar-expand-md navbar-properties-custom">
                            ...
                            for($i = 0; $i < count($shoesDataArray); $i++){
                                ...
                                print '<div class="col-3 offset-1 mt-5 shoes-cards">';
                                    ...
                                    print '<div class="shoe-title">';
                                        ...
                                        print '<a href="/delete?id='.$shoesDataArray[$i][0].'"><button class="shoe-remove-button">REMOVE</button> </a>';
                                    print '</div>';
                                print '</div>';  
                            }
                        ?>
        ...
        <script src="{{asset('/js/removeProduct.js')}}"></script> 
</body>
</html>