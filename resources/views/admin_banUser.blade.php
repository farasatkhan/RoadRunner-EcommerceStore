...
<nav class="navbar navbar-light navbar-expand-md navbar-properties-custom">
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="subLogin offset-lg-2 col-lg-8 offset-mg-4 col-mg-8 col-10 offset-1">
                                    <form id="ban-user-account-form" action="/admin_banUser" method="POST">
                                        @csrf
                                        <p class="admin-newadmin-form-title">Ban Existing User</p>
                                        <input  id="email" name="email" type="text" class="formTextFeild" placeholder="Email" required>
                                        <p id="email-validation-error"></p>
                                        <input type="submit" name="Login" id="Login" value="Ban Existing User" class="btn1">
                                    </form>
                                    <?php
                                        if (!empty($status)){
        ...
        <script>
            ...
            var form = document.getElementById("ban-user-account-form");
